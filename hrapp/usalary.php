                    ...
                    <tbody>
                        ...
                        if ($resultAllRows && $resultAllRows->num_rows > 0) {
                            while ($rowAllRows = $resultAllRows->fetch_assoc()) {
                                ...
                                <td><a href='invoice.php?date=" . $rowAllRows["date"] . "&basicsalary=" . $rowAllRows["basicsalary"] . "&allowance=" . $rowAllRows["allowance"] . "&total=" . $rowAllRows["total"] . "'><button>Payslip</button></a></td>
                            </tr>";
