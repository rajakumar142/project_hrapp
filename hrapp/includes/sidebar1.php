...
.menu, .menu-bar, .menu-bar2, .menu-bar3 {
    position: fixed;
    top: 0;
    left: 0;
    height: 100%;
...
.menu-bar li a, .menu-bar li a, .menu-bar3 li a {
    display: block;
    height: 3em;
    line-height: 3em;
    color: #72739f;
...
<ul class="menu">
  <li title="dash"><a href="udash.php" class="dash"><i class="fa-solid fa-gauge-simple"></i></a></li>
  <li title="Profile"><a href="uprofile.php" ><i class="fa-solid fa-users"></i></a></li>
  <li title="leave"><a href="#" class="menu-button"><i class="fa-solid fa-calendar-days"></i></a></li>
  <li title="salary"><a href="usalary.php" ><i class="fa-solid fa-money-bill"></i></a></li>
...
<ul class="menu-bar">
    ...
    <li class="dropdown-btn">
      ...
      <a href="uleavehistory.php">Leave History</a>
		<a href="applyleave.php"> Apply Leave</a>
		<a href="applypermission.php"> Apply Premission</a>
	  </div>
